...
## adapted from ramen code base
class FCNet_ramen(nn.Module):
    """Simple class for non-linear fully connect network
    """
    def __init__(self, dims, act='ReLU', dropout=0):
        super(FCNet_ramen, self).__init__()
...
class FCNet(nn.Module):
    """Simple class for non-linear fully connect network
    """
    def __init__(self, dims, dropout=0, norm='weight', act='ReLU'):
...
class FCNet_linear(nn.Module):
    """Simple class for linear fully connect network
    """
    def __init__(self, dims, norm='weight'):
        super(FCNet_linear, self).__init__()
