...
if __name__ == '__main__':
    ...
    elif opt.model_type == 'updn_ramen_transfer':
        from models.updn import UpDn_ramen_transfer
        model = UpDn_ramen_transfer(opt)
    elif opt.model_type == 'updn_ramen_text':
        from models.updn import UpDn_ramen_text
        model = UpDn_ramen_text(opt)
